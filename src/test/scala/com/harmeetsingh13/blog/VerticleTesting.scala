package com.harmeetsingh13.blog
...
abstract class VerticleTesting[A <: ScalaVerticle : TypeTag](deploymentOptions: DeploymentOptions = DeploymentOptions())
  extends AsyncFlatSpec with BeforeAndAfter {
